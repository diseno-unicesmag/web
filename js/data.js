...
const CONFIG = {
  ...
  folletoOficial: "https://www.unicesmag.edu.co/recursos/uploads/2025/07/Diseno-UNICESMAG-2025.pdf",
};
...
const FICHA = [
  ...
  { k: "Matrícula semestral", v: "$3.760.000 COP · Valor por crédito: $235.000 COP" },
...
const PROYECTOS = [
  {
    id: "demo-1", demo: true, categoria: "branding",
    titulo: "Sistema de identidad para emprendimiento local",
    estudiante: "[Estudiante de Taller IV]", semestre: "4º semestre",
    asignatura: "Diseño IV: Identidad visual", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-2", demo: true, categoria: "editorial",
    titulo: "Publicación experimental de tipografía regional",
    estudiante: "[Estudiante de Taller VI]", semestre: "6º semestre",
    asignatura: "Diseño VI: Editorial", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-3", demo: true, categoria: "multimedia",
    titulo: "Motion graphics y pieza audiovisual de campaña",
    estudiante: "[Estudiante de Taller VIII]", semestre: "8º semestre",
    asignatura: "Diseño VIII: Multimedia e interactivo", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-4", demo: true, categoria: "social",
    titulo: "Identidad y piezas para fundación comunitaria",
    estudiante: "[Estudiante de Taller VII]", semestre: "7º semestre",
    asignatura: "Investigación I / Ecodiseño", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-5", demo: true, categoria: "branding",
    titulo: "Campaña publicitaria y estrategia de producto",
    estudiante: "[Estudiante de Taller V]", semestre: "5º semestre",
    asignatura: "Diseño V: Señalética & Medios", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-6", demo: true, categoria: "editorial",
    titulo: "Cartel serigrafiado — muestra de taller análogo",
    estudiante: "[Estudiante de Taller III]", semestre: "3º semestre",
    asignatura: "Diseño III: Tipografía", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-7", demo: true, categoria: "multimedia",
    titulo: "Prototipo interactivo 3D y entorno lúdico",
    estudiante: "[Estudiante de Taller VIII]", semestre: "8º semestre",
    asignatura: "Electiva Creación Interactiva / Videojuegos", docente: "[Docente guía de taller]",
  ...
  {
    id: "demo-8", demo: true, categoria: "social",
    titulo: "Sistema visual para patrimonio y fiesta andina",
    estudiante: "[Estudiante de Proyecto de Grado]", semestre: "10º semestre",
    asignatura: "Proyecto de Grado II", docente: "[Comité de Grado]",
...
const HERRAMIENTAS_APPS = [
  {
    ...
    apps: [
      { nombre: "Adobe Illustrator", tag: "Vectorial & Marca", desc: "Diseño de identidad, logotipos, tipografía vectorial e infografía." },
      { nombre: "Adobe Photoshop", tag: "Arte & Retoque", desc: "Composición avanzada, retoque fotográfico y pintura digital." },
      { nombre: "Adobe InDesign", tag: "Editorial", desc: "Maquetación de libros, revistas, fanzines y publicaciones impresas y digitales." },
      { nombre: "Adobe After Effects", tag: "Motion Graphics", desc: "Animación 2D, gráficos en movimiento y efectos visuales." },
      { nombre: "Adobe Premiere Pro", tag: "Video & Montaje", desc: "Edición audiovisual, montaje narrativo y posproducción de sonido." },
      { nombre: "Adobe Lightroom", tag: "Fotografía", desc: "Revelado digital, calibración cromática y archivo fotográfico." },
    ],
  },
  {
    categoria: "3D, Interacción & Código Creativo",
    apps: [
      { nombre: "ZBrush", tag: "Escultura Digital", desc: "Modelado orgánico de alta resolución y creación de personajes." },
      { nombre: "KeyShot", tag: "Render & Materiales", desc: "Renderizado fotorrealista, simulación de materiales e iluminación de producto." },
      { nombre: "Processing", tag: "Código Creativo", desc: "Programación visual generativa, algoritmos y arte computacional." },
      { nombre: "Unity", tag: "Interactividad 3D", desc: "Entornos interactivos, experiencias inmersivas y prototipado de videojuegos." },
      { nombre: "Arduino", tag: "Interacción Física", desc: "Prototipado con sensores, actuadores y diseño de interfaces tangibles." },
      { nombre: "Spatial", tag: "Entornos Virtuales", desc: "Montaje de galerías inmersivas y experiencias 3D en la web." },
      { nombre: "Figma", tag: "UI / UX & Web", desc: "Diseño de interfaces, arquitectura de información y prototipado interactivo." },
    ],
  },
  {
    categoria: "Talleres y Oficio Físico",
    apps: [
      { nombre: "Taller de Serigrafía y Grabado", tag: "Impresión Análoga", desc: "Mesas de estampado, emulsión, linograbado, tintas y experimentación en papel y textil." },
      { nombre: "Set de Fotografía e Iluminación", tag: "Estudio & Cámara", desc: "Luces de estudio, ciclorama, ópticas profesionales y dirección de arte en set." },
      { nombre: "Taller de Encuadernación y Empaques", tag: "Editorial & Estructuras", desc: "Troquelado manual, plegados, costura artesanal y prototipado de empaques tridimensionales." },
      { nombre: "Taller de Técnicas Manuales y Aerografía", tag: "Expresión Plástica", desc: "Aerógrafo, pigmentos, acuarela, tinta y fundamentos plásticos de Bellas Artes." },
    ],
  },
];
...
const FASES = {
  descubrir: {
    ...
    resumen: "El estudiante descubre el oficio desde la base plástica, el dibujo, la morfología, la composición y los primeros lenguajes digitales.",
    color: "#ffc433",
  ...
  conocer: {
    ...
    resumen: "Profundización técnica y conceptual: identidad visual, tipografía, infografía, sistemas de impresión, audiovisual, animación y modelado 3D.",
    color: "#5bc0f5",
  ...
  estructurar: {
    ...
    resumen: "Autonomía profesional, electivas de creación interactiva/videojuegos, marketing estratégico, ecodiseño, práctica empresarial y sustentación de grado.",
    color: "#ff7054",
...
const MALLA = [
  {
    semestre: 1, ordinal: "1er Semestre", creditos: 16, fase: "descubrir",
    eje: "Diseño I: Bidimensional",
    descripcionFase: "Fundamentación en el plano, dibujo de observación y primeras herramientas vectoriales.",
    asignaturas: [
      { n: "Diseño I: Bidimensional", c: 4, isEje: true, d: "Primer taller troncal del eje de diseño. Sintaxis visual, composición en el plano, ritmo, equilibrio y estructura del mensaje gráfico." },
      { n: "Morfología I: Color y forma", c: 2, isEje: false, d: "El color, el contraste y la forma como materia prima del lenguaje visual y la percepción." },
      { n: "Dibujo I", c: 2, isEje: false, d: "Fundamentos de la expresión gráfica: observación, línea, valoración tonal, encuadre y proporción manual." },
      { n: "Medios digitales I: Diseño vectorial", c: 3, isEje: false, d: "Inicio de la ruta digital: software de vectorización, ilustración digital y dibujo de precisión en Adobe Illustrator." },
      { n: "Fundamentos de la comunicación", c: 3, isEje: false, d: "Bases teóricas de la comunicación humana, modelos semióticos y el rol del diseñador como emisor visual." },
      { n: "Filosofía institucional", c: 2, isEje: false, d: "Formación humanista y franciscana con sentido de responsabilidad social y ética comunitaria." },
    ],
  },
  {
    semestre: 2, ordinal: "2do Semestre", creditos: 15, fase: "descubrir",
    eje: "Diseño II: Tridimensional",
    descripcionFase: "Exploración del volumen, la biónica de la naturaleza y el arte digital.",
    asignaturas: [
      { n: "Diseño II: Tridimensional", c: 4, isEje: true, d: "El taller avanza hacia la espacialidad: relaciones volumétricas, materiales, texturas, escala y prototipado físico." },
      { n: "Morfología II: Biónica formal", c: 2, isEje: false, d: "Análisis y abstracción de estructuras y patrones de la naturaleza aplicados a soluciones formales de diseño." },
      { n: "Dibujo II", c: 2, isEje: false, d: "El dibujo como herramienta de conceptualización rápida, bocetación proyectual y representación expresiva." },
      { n: "Medios digitales II: Arte digital", c: 3, isEje: false, d: "Pintura digital, tratamiento fotográfico, fotomontaje y técnicas avanzadas en Adobe Photoshop." },
      { n: "Fotografía I", c: 2, isEje: false, d: "Fundamentos técnicos y estéticos de la cámara: óptica, exposición, iluminación de estudio y composición." },
      { n: "Historia I", c: 2, isEje: false, d: "Recorrido por la historia del arte y las vanguardias visuales como fuente de inspiración proyectual." },
    ],
  },
  {
    semestre: 3, ordinal: "3er Semestre", creditos: 16, fase: "descubrir",
    eje: "Diseño III: Tipografía",
    descripcionFase: "El universo de la letra, la ilustración de autor y los principios de animación 2D.",
    asignaturas: [
      { n: "Diseño III: Tipografía", c: 4, isEje: true, d: "El taller de la letra: anatomía, familias tipográficas, jerarquía, legibilidad y diseño de alfabetos experimentales." },
      { n: "Composición gráfica", c: 2, isEje: false, d: "Sintaxis visual avanzada: grillas modulares, diagramación armónica y tensión compositiva." },
      { n: "Ilustración I", c: 3, isEje: false, d: "Desarrollo del lenguaje ilustrado, técnicas mixtas y búsqueda de una voz gráfica personal." },
      { n: "Medios digitales III: Animación 2D", c: 3, isEje: false, d: "Principios fundamentales de animación: timing, interpolación, personajes y narrativa en movimiento con After Effects." },
      { n: "Fotografía II", c: 2, isEje: false, d: "Fotografía publicitaria, retrato, iluminación conceptual y dirección de arte fotográfica en estudio." },
      { n: "Historia II", c: 2, isEje: false, d: "Historia del diseño gráfico moderno, escuelas de diseño (Bauhaus, Escuela Suiza) y diseño latinoamericano." },
    ],
  },
  {
    semestre: 4, ordinal: "4to Semestre", creditos: 15, fase: "conocer",
    eje: "Diseño IV: Identidad visual",
    descripcionFase: "Creación de marcas, narrativas infográficas y producción audiovisual.",
    asignaturas: [
      { n: "Diseño IV: Identidad visual", c: 4, isEje: true, d: "El taller de branding: diseño de identificadores de marca, manuales de normas, sistemas visuales y aplicaciones con clientes reales." },
      { n: "Diseño de información I: Infografía", c: 2, isEje: false, d: "Traducción de datos complejos y hechos en relatos visuales, mapas, esquemas y diagramas informativos." },
      { n: "Ilustración II", c: 3, isEje: false, d: "Ilustración aplicada a proyectos editoriales, publicitarios y narrativas gráficas complejas." },
      { n: "Medios digitales IV: Producción audiovisual", c: 3, isEje: false, d: "Lenguaje cinematográfico, grabación en set, captura de audio profesional y edición no lineal con Premiere Pro." },
      { n: "Semiótica visual", c: 2, isEje: false, d: "Análisis del signo, significado y contexto cultural para la codificación y decodificación de mensajes." },
      { n: "Electiva recreativa: Deporte formativo", c: 1, isEje: false, d: "Bienestar físico, hábitos saludables y trabajo en equipo para el desarrollo integral del estudiante." },
    ],
  },
  {
    semestre: 5, ordinal: "5to Semestre", creditos: 15, fase: "conocer",
    eje: "Diseño V: Señalética",
    descripcionFase: "Diseño en el espacio público, visualización de datos y sistemas de impresión industrial.",
    asignaturas: [
      { n: "Diseño V: Señalética", c: 4, isEje: true, d: "Sistemas de orientación espacial, wayfinding, pictogramas, ergonomía visual y señalización arquitectónica." },
      { n: "Diseño de información II: Visualización de datos", c: 2, isEje: false, d: "Visualización avanzada de información masiva, dashboards interactivos y periodismo de datos." },
      { n: "Sistemas de impresión", c: 2, isEje: false, d: "Procesos litográficos, offset, serigrafía, flexografía, sustratos, tintas y preparación técnica de artes finales." },
      { n: "Medios digitales V: Comunicación audiovisual", c: 3, isEje: false, d: "Posproducción audiovisual, corrección de color, efectos visuales (VFX) y diseño sonoro." },
      { n: "Retórica de la imagen", c: 2, isEje: false, d: "Figuras retóricas, metáforas visuales y estrategias persuasivas para campañas de alto impacto." },
      { n: "Ética de valores", c: 2, isEje: false, d: "Reflexión ética y valores para el ejercicio responsable y humanizado de la profesión." },
    ],
  },
  {
    semestre: 6, ordinal: "6to Semestre", creditos: 14, fase: "conocer",
    eje: "Diseño VI: Editorial",
    descripcionFase: "Publicaciones impresas y digitales, modelado 3D y electivas de creación interactiva.",
    asignaturas: [
      { n: "Diseño VI: Editorial", c: 4, isEje: true, d: "El taller del libro y la revista: arquitectura editorial, retículas complejas, tipografía editorial y maquetación en InDesign." },
      { n: "Electiva disciplinar I D: Videojuegos I / Creación interactiva I", c: 2, isEje: false, d: "Ruta especializada: diseño conceptual de videojuegos, lógica de interactividad y experiencias inmersivas." },
      { n: "Electiva interdisciplinar I", c: 3, isEje: false, d: "Diálogo transdisciplinar con otros saberes de la Facultad de Arquitectura y Bellas Artes." },
      { n: "Medios digitales VI: Modelado 3D", c: 3, isEje: false, d: "Creación de mallas 3D, escultura digital (ZBrush/Blender), texturizado, iluminación y renderizado." },
      { n: "Teoría de la percepción", c: 2, isEje: false, d: "Leyes de la Gestalt, psicología del color, cognición visual y comportamiento del usuario." },
    ],
  },
  {
    semestre: 7, ordinal: "7mo Semestre", creditos: 14, fase: "estructurar",
    eje: "Diseño VII: Empaques",
    descripcionFase: "Diseño de envases, marketing estratégico, entornos web y arranque de investigación.",
    asignaturas: [
      { n: "Diseño VII: Empaques", c: 4, isEje: true, d: "Packaging estructural y gráfico: troqueles, materiales sostenibles, ergonomía en góndola y experiencia de unboxing." },
      { n: "Electiva disciplinar II D: Videojuegos II / Creación interactiva II", c: 2, isEje: false, d: "Programación visual, motores interactivos (Unity/Processing) y prototipado de experiencias lúdicas." },
      { n: "Entornos web", c: 2, isEje: false, d: "Diseño UI/UX (Figma), arquitectura de información, diseño responsive y maquetación web moderna." },
      { n: "Investigación I", c: 2, isEje: false, d: "Metodologías de investigación-creación, formulación de problemas de diseño y estado del arte." },
      { n: "Gestión del diseño I: Marketing estratégico", c: 2, isEje: false, d: "Modelos de negocio creativos, análisis de mercado, segmentación y posicionamiento de marcas." },
      { n: "Inglés I", c: 2, isEje: false, d: "Primer módulo de lengua extranjera con enfoque en comunicación profesional global." },
    ],
  },
  {
    semestre: 8, ordinal: "8vo Semestre", creditos: 17, fase: "estructurar",
    eje: "Diseño VIII: Multimedia e interactivo",
    descripcionFase: "Experiencias interactivas, dirección de proyectos y formalización de la tesis.",
    asignaturas: [
      { n: "Diseño VIII: Multimedia e interactivo", c: 4, isEje: true, d: "Diseño de experiencias complejas: interfaces digitales, interactivos para museos, realidad aumentada y multimedia." },
      { n: "Electiva disciplinar III D: Videojuegos III / Creación interactiva III", c: 2, isEje: false, d: "Cierre de la ruta electiva con desarrollo de un prototipo jugable o producto interactivo completo." },
      { n: "Electiva interdisciplinar II", c: 3, isEje: false, d: "Colaboración en proyectos con áreas de ingeniería, ciencias sociales o administración." },
      { n: "Investigación II", c: 4, isEje: false, d: "Desarrollo del marco metodológico, trabajo de campo y validación del proyecto de investigación-creación." },
      { n: "Gestión del diseño II: Gestión de proyectos de diseño", c: 2, isEje: false, d: "Planificación de presupuestos, cronogramas ágiles, costos de diseño y dirección de equipos creativos." },
      { n: "Inglés II", c: 2, isEje: false, d: "Segundo módulo de inglés enfocado en lectura crítica y terminología especializada de diseño." },
    ],
  },
  {
    semestre: 9, ordinal: "9no Semestre", creditos: 18, fase: "estructurar",
    eje: "Servicio profesional · Proyecto de grado I",
    descripcionFase: "Inmersión total en la práctica empresarial, ecodiseño y diseño de servicios.",
    asignaturas: [
      { n: "Servicio profesional en diseño", c: 8, isEje: true, d: "Práctica empresarial de un semestre completo en agencias, empresas, estudios de diseño u organizaciones públicas." },
      { n: "Ecodiseño", c: 2, isEje: false, d: "Diseño circular, análisis de ciclo de vida (ACV), huella ambiental y responsabilidad ecológica del producto." },
      { n: "Proyecto de grado I", c: 4, isEje: true, d: "Producción y desarrollo formal del proyecto de grado bajo la asesoría de docentes especialistas." },
      { n: "Gestión del diseño III: Diseño de servicio", c: 2, isEje: false, d: "Service Design: mapeo de viajes de usuario (Customer Journey), blueprints y diseño de experiencias integrales." },
      { n: "Inglés III", c: 2, isEje: false, d: "Tercer módulo de inglés: redacción de propuestas y preparación para entornos internacionales." },
    ],
  },
  {
    semestre: 10, ordinal: "10mo Semestre", creditos: 17, fase: "estructurar",
    eje: "Proyecto de grado II",
    descripcionFase: "Sustentación del proyecto de grado, diseño de exhibiciones y consultoría en diseño.",
    asignaturas: [
      { n: "Proyecto de grado II", c: 6, isEje: true, d: "Culminación, producción final, validación y sustentación pública del proyecto de grado ante jurados." },
      { n: "Diseño de exhibición", c: 2, isEje: false, d: "Diseño de stands, museografía, montaje de muestras de grado y exhibición espacial del portafolio." },
      { n: "Ética profesional", c: 2, isEje: false, d: "Marco legal del diseñador, derechos de autor, propiedad intelectual, contratos y deontología profesional." },
      { n: "Electiva interdisciplinar III", c: 3, isEje: false, d: "Último espacio de integración con proyectos de impacto regional y social." },
      { n: "Gestión del diseño IV: Consultoría en diseño", c: 2, isEje: false, d: "El diseñador como consultor estratégico: diagnósticos organizacionales, auditoría de marca y planes de acción." },
      { n: "Inglés IV", c: 2, isEje: false, d: "Módulo final de inglés para alcanzar el nivel B1 y culminar el requisito institucional de grado." },
    ],
  },
];
...
const ECOSISTEMA = [
  {
    ...
    destacado: "Publicaciones · Ponencias · Proyectos con impacto en el territorio",
  },
  {
    id: "tiendad",
...
const NOTICIAS = [
  ...
  },
  {
    ...
    cuerpo: "Con conferencias magistrales, duelos creativos, workshops especializados e ICItalks, el Festival BUENAMENTE 2025 celebró una década de trayectoria posicionándose como uno de los encuentros de diseño más influyentes del suroccidente colombiano. Diseñadores invitados de nivel nacional e internacional compartieron sus visiones sobre inteligencia artificial aplicada al diseño, tipografía vernácula, diseño estratégico y gestión de marcas con impacto sostenible.",
    enlace: "comunidad.html#noticias",
