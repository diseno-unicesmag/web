...
const DOCENTES = [
  {
    ...
    destacado: "Profesional en Diseño · Estratega de Marca",
    color: "#ff7054",
    perfil:
      "Profesional en diseño y estratega en comunicación visual. Se desempeña como planeador y consultor de marca con amplio enfoque en el desarrollo y posicionamiento de proyectos en la región de Nariño.",
  ...
  },
  {
    ...
    color: "#ffc433",
    perfil:
      "Diseñadora Industrial y Magíster en Humanidades Digitales. Cuenta con especializaciones en Gestión Estratégica del Diseño y en Lógica y Técnica de la Forma, orientadas a la investigación proyectual y morfológica.",
    avatar: "assets/img/profesores/karol-ibarra.png",
  },
  {
    id: "doc-03",
    nombre: "Karen Ocaña",
    tag: "Diseño Urbano & Sustentable",
    destacado: "Magíster en Diseño Urbano Sustentable · Diseñadora Industrial",
    color: "#6d4ac4",
    perfil:
      "Diseñadora Industrial (Udenar), Magíster en Diseño Urbano y Arquitectónico Sustentable (Gestalt, México) y Especialista en Mobiliario (UBA, Argentina). Docente con más de seis años de experiencia en Diseño Gráfico e Industrial.",
  ...
  },
  {
    ...
    destacado: "Doctor en Tecnologías de la Información y la Comunicación",
    color: "#ffc433",
    perfil:
      "Doctor en TIC (Tech) y Magíster en Tecnología Educativa y Competencias Digitales (UNIR). Diseñador Gráfico y Multimedial (Udenar), Ingeniero de Sistemas (INDESCO - UCC) y Licenciado en Informática (Udenar).",
    avatar: "assets/img/profesores/mauricio-montenegro.png",
  },
  {
    id: "doc-05",
    nombre: "Karol Suarez",
    tag: "Innovación & Producto",
    destacado: "Magíster en Innovación y Producto · Diseñadora Industrial",
    color: "#ff7054",
    perfil:
      "Diseñadora Industrial (Udenar), Especialista en Gerencia de Diseño (UTADEO), Magíster en Desarrollo de Proyectos de Innovación y Producto (UNINI) y Candidata a Magíster en Diseño para la Innovación Social.",
    avatar: "assets/img/profesores/karol-suarez.png",
  },
  {
    id: "doc-06",
    nombre: "Mauricio Feuillet",
    tag: "Docencia & Diseño Social",
    destacado: "Especialista en Docencia Universitaria & Gerencia en Diseño",
    color: "#ff7054",
    perfil:
      "Diseñador Industrial y docente de diseño. Cuenta con especializaciones en Docencia Universitaria y Gerencia en Diseño, y es Candidato a Magíster en Diseño para la Innovación Social.",
    avatar: "assets/img/profesores/mauricio-feuillet.png",
  },
  {
    id: "doc-07",
    nombre: "Arturo De la Cruz",
    tag: "Creación Interactiva",
    destacado: "Magíster en Creación Interactiva · Ingeniero & Diseñador",
    color: "#ffc433",
    perfil:
      "Ingeniero de Sistemas y Diseñador Gráfico. Magíster en Diseño y Creación Interactiva (U. de Caldas) con Posgrado en Artes Mediales cursado en convenio internacional (U. de Córdoba, U. de Chile y U. de Caldas).",
  ...
  },
  {
    ...
    color: "#ff7054",
    perfil:
      "Diseñador Gráfico y Magíster en Comunicación e Identidad Corporativa (UNIR). Docente enfocado en sistemas de identidad visual, comunicación estratégica de marca y gestión de imagen corporativa.",
    avatar: "assets/img/profesores/mateo-teran.png",
  },
  {
    id: "doc-09",
    nombre: "Ramón Ortega",
    tag: "Artes Mediales & RAD",
    destacado: "Magíster en Creación Interactiva · Exdirectivo RAD",
    color: "#ffc433",
    perfil:
      "Diseñador Gráfico, Magíster en Diseño y Creación Interactiva (U. de Caldas) y Posgrado en Artes Mediales (U. de Córdoba, U. de Chile, U. de Caldas). Exmiembro del Consejo Directivo de la Red Académica de Diseño (RAD).",
    avatar: "assets/img/profesores/ramon-ortega.png",
  },
  {
    id: "doc-10",
    nombre: "Fernando Coral",
    tag: "Audiovisual & Creación Interactiva",
    destacado: "Magíster en Creación Interactiva · Diseñador Gráfico",
    color: "#ffc433",
    perfil:
      "Diseñador Gráfico y Especialista en Gerencia del Diseño (UTADEO), Magíster en Diseño y Creación Interactiva (U. de Caldas) y Tecnólogo en Producción de Radio y TV (CST) con trayectoria en medios audiovisuales.",
    avatar: "assets/img/profesores/fernando-coral.png",
  },
  {
    id: "doc-11",
    nombre: "Amanda Arteaga",
    tag: "Investigación & Etnoliteratura",
    destacado: "Magíster en Etnoliteratura · Docente Investigadora",
    color: "#6d4ac4",
    perfil:
      "Docente Investigadora con Pregrado en Filosofía, Especialización en Estudios Latinoamericanos y Maestría en Etnoliteratura. Diplomada en Pensamiento de Diseño e Identidad Gorettiana.",
  ...
  },
  {
    ...
    destacado: "Diseñador Gráfico, Investigador y Fotógrafo Premiado",
    color: "#5bc0f5",
    perfil:
      "Diseñador Gráfico, investigador y fotógrafo internacional con experiencia en diseño editorial, branding, museografía y cortometrajes. Reconocido en los Sony World Photography Awards y 35Awards.",
    avatar: "assets/img/profesores/carlos-jimenez.png",
  },
  {
    id: "doc-13",
    nombre: "Juan Pinzón",
    tag: "Fotografía Documental",
    destacado: "Candidato a Magíster en Diseño Fotográfico (U. Iberoamericana)",
    color: "#5bc0f5",
    perfil:
      "Diseñador de Comunicación Visual (Javeriana Cali) y fotógrafo documental residente en México. Docente en la Universidad de Celaya y en la Universidad Latina de México, enfocado en memoria e identidad cultural.",
    avatar: "assets/img/profesores/juan-pinzon.png",
  },
  {
    id: "doc-14",
    nombre: "Camilo Varona",
    tag: "Art Toys & Tradición Oral",
    destacado: "Maestro Artesano Contemporáneo · Fundador de Taller Makaco",
    color: "#6d4ac4",
    perfil:
      "Diseñador Gráfico (UNICESMAG) y maestro artesano contemporáneo. En 2012 fundó Taller Makaco, espacio donde fusiona ilustración, tradición oral andina y narrativa en art toys con proyección internacional.",
  ...
  },
  {
    ...
    destacado: "CEO Lab of Shadows · Diseñador Gráfico & Animador 3D",
    color: "#ffc433",
    perfil:
      "Diseñador Gráfico, animador 3D certificado en Autodesk Maya y CEO de Lab of Shadows. Especialista en escultura digital, concept art, storyboarding, iluminación, modelado y animación de personajes.",
  ...
  },
  {
    ...
    destacado: "Diseñador Gráfico (Udenar) · Magíster · Cofundador de Milhojas",
    color: "#5bc0f5",
    perfil:
      "Diseñador Gráfico (Udenar), docente e investigador vinculado a UNICESMAG. Especialista en sistemas de impresión y procesos técnicos. En el plano independiente es calígrafo y cofundador de Milhojas Cuadernos.",
    avatar: "assets/img/profesores/leonardo-hidalgo.png",
  },
  {
    id: "doc-17",
    nombre: "Natalia Timarán",
    tag: "Diseño Social & Emprendimiento",
    destacado: "Docente Investigadora · Grupo Cooper · Reconocimiento Institucional",
    color: "#6d4ac4",
    perfil:
      "Diseñadora Gráfica, docente e investigadora de UNICESMAG vinculada al Grupo Cooper. Dicta Proyecto Empresarial II (Plan de Negocios) y ha sido galardonada institucionalmente por su aporte cultural y artístico.",
