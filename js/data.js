...
const DOCENTES = [
  {
    id: "doc-01",
    nombre: "Karen Eugenia Ocaña Figueroa",
    titulo: "Magíster en Diseño y Creación Funcional",
    pregrado: "Diseñadora Gráfica",
    area: "taller",
    cargo: "Directora de Programa & Docente Titular",
    asignaturas: "Diseño IV (Identidad) · Proyecto de Grado I y II",
    investigacion: "Líder Grupo de Investigación D+I Gráfico · Gestión del Diseño",
    email: "disenografico@unicesmag.edu.co",
    avatar: "assets/img/karen.jpg",
  },
  {
    id: "doc-02",
    nombre: "Santiago Pantoja Benavides",
    titulo: "Magíster en Comunicación Visual y Nuevos Medios",
    pregrado: "Diseñador Gráfico",
    area: "publicidad",
    cargo: "Docente de Planta",
    asignaturas: "Diseño V: Señalética & Empaques · Publicidad y Medios",
    investigacion: "Estrategias de comunicación de marca y empaque sostenible",
    avatar: "",
  },
  {
    id: "doc-03",
    nombre: "Marcela Gómez Rosero",
    titulo: "Magíster en Diseño Editorial y Producción Gráfica",
    pregrado: "Diseñadora Gráfica",
    area: "editorial",
    cargo: "Docente de Planta · Coordinadora de Taller",
    asignaturas: "Diseño VI: Diseño Editorial · Tipografía Avanzada",
    investigacion: "Tipografía vernácula y publicaciones experimentales",
    avatar: "",
  },
  {
    id: "doc-04",
    nombre: "Orlando Javier Ortiz Chaves",
    titulo: "Especialista en Animación Digital y Modelado 3D",
    pregrado: "Diseñador Gráfico (Graduado UNICESMAG)",
    area: "digital",
    cargo: "Docente Catedrático · Artista Digital",
    asignaturas: "Diseño VIII: Multimedia & 3D · Art Toys & Modelado",
    investigacion: "Diseño de personajes, Art Toys y cultura lúdica andina",
    avatar: "",
  },
  {
    id: "doc-05",
    nombre: "Álvaro Vallejo Enríquez",
    titulo: "Especialista en Ecodiseño y Sostenibilidad",
    pregrado: "Diseñador Industrial y Visual",
    area: "teoria",
    cargo: "Docente de Planta · Investigador",
    asignaturas: "Investigación-Creación I & II · Ecodiseño · Metodología",
    investigacion: "Diseño para la sostenibilidad y codiseño comunitario",
    avatar: "",
  },
  {
    id: "doc-06",
    nombre: "Javier Guerrero Villota",
    titulo: "Maestro en Artes Plásticas y Visuales",
    pregrado: "Artista Visual & Grabador",
    area: "editorial",
    cargo: "Docente de Taller de Técnicas Análogas",
    asignaturas: "Dibujo y Forma · Técnicas de Grabado y Serigrafía · Ilustración",
    investigacion: "Técnicas gráficas tradicionales y patrimonio visual de Nariño",
    avatar: "",
  },
  {
    id: "doc-07",
    nombre: "Fernando Muñoz Cabrera",
    titulo: "Magíster en Creación Audiovisual y Motion Graphics",
    pregrado: "Diseñador Gráfico & Productor Audiovisual",
    area: "digital",
    cargo: "Docente de Planta",
    asignaturas: "Medios Digitales IV · Animación Digital · Producción Audiovisual",
    investigacion: "Motion design, micro-animación y diseño sonoro",
    avatar: "",
  },
  {
    id: "doc-08",
    nombre: "Carlos Burbano Chamorro",
    titulo: "Magíster en Experiencia de Usuario e Interfaces Digitales (UX/UI)",
    pregrado: "Diseñador Gráfico & Desarrollador Frontend",
    area: "digital",
    cargo: "Docente de Planta",
    asignaturas: "Diseño IX: UX/UI & Entornos Web · Prototipado Interactivo",
    investigacion: "Accesibilidad digital, Design Systems y usabilidad móvil",
    avatar: "",
  },
  {
    id: "doc-09",
    nombre: "Camilo Andrés Varona Guerrero",
    titulo: "Magíster en Educación y Procesos Creativos",
    pregrado: "Diseñador Gráfico (Graduado UNICESMAG)",
    area: "taller",
    cargo: "Docente de Planta · Coordinación de Egresados",
    asignaturas: "Diseño I: Fundamentos · Taller de Experimentación Visual",
    investigacion: "Pedagogías del diseño y articulación con graduados",
    avatar: "assets/img/egresados/camilo-varona.png",
  },
  {
    id: "doc-10",
    nombre: "Lucía Paredes Delgado",
    titulo: "Doctora en Historia y Teoría del Arte y la Imagen",
    pregrado: "Historiadora del Arte & Semióloga",
    area: "teoria",
    cargo: "Docente Titular · Investigadora Sénior",
    asignaturas: "Historia del Diseño y la Imagen I y II · Semiótica Visual",
    investigacion: "Semiótica andina, iconografía prehispánica y cultura visual",
    avatar: "",
  },
  {
    id: "doc-11",
    nombre: "Andrés Felipe Erazo Mora",
    titulo: "Magíster en Estrategia de Marca y Branding Corporativo",
    pregrado: "Diseñador Gráfico & Publicista",
    area: "publicidad",
    cargo: "Docente Catedrático",
    asignaturas: "Diseño III: Identidad y Sistemas de Comunicación · Marketing",
    investigacion: "Branding territorial y economía creativa en el sur colombiano",
    avatar: "",
  },
  {
    id: "doc-12",
    nombre: "Diana Patricia Santacruz",
    titulo: "Especialista en Ilustración Infantil y Narrativa Gráfica",
    pregrado: "Diseñadora Gráfica e Ilustradora",
    area: "editorial",
    cargo: "Docente Catedrática",
    asignaturas: "Ilustración Análoga y Digital · Álbum Ilustrado · Narrativa",
    investigacion: "Libro álbum, narrativa visual y tradición oral de Nariño",
    avatar: "",
  },
  {
    id: "doc-13",
    nombre: "Gabriel Alejandro Melo Bastidas",
    titulo: "Especialista en Fotografía Publicitaria e Iluminación de Estudio",
    pregrado: "Diseñador Gráfico & Fotógrafo",
    area: "digital",
    cargo: "Docente de Laboratorio de Fotografía",
    asignaturas: "Fotografía Básica y Avanzada · Dirección de Arte Fotográfica",
    investigacion: "Fotografía documental de oficios tradicionales y retrato editorial",
    avatar: "",
  },
  {
    id: "doc-14",
    nombre: "María Elena Revelo Coral",
    titulo: "Magíster en Antropología Visual y Diseño Social",
    pregrado: "Diseñadora Gráfica",
    area: "teoria",
    cargo: "Docente Investigadora",
    asignaturas: "Diseño Social y Comunitario · Ética Profesional del Diseñador",
    investigacion: "Etnografía visual, diseño social e innovación comunitaria",
    avatar: "",
  },
  {
    id: "doc-15",
    nombre: "Víctor Hugo Rosero Díaz",
    titulo: "Especialista en Diseño Tipográfico y Caligrafía",
    pregrado: "Diseñador Gráfico",
    area: "editorial",
    cargo: "Docente de Taller",
    asignaturas: "Tipografía I: Anatomía y Letra · Caligrafía y Lettering",
    investigacion: "Rescate caligráfico de manuscritos históricos regionales",
    avatar: "",
  },
  {
    id: "doc-16",
    nombre: "Esteban Rodrigo Cadena López",
    titulo: "Magíster en Creatividad y Gestión de Proyectos de Innovación",
    pregrado: "Diseñador Gráfico",
    area: "taller",
    cargo: "Docente de Planta · Asesor de Grado",
    asignaturas: "Diseño VII: Innovación y Emprendimiento · Práctica Profesional",
    investigacion: "Design Thinking, modelos de negocio creativos y portafolio",
    avatar: "",
  },
];
